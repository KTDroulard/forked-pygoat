...
An intentionally vulnerable web Application Security in django.
...
- [Table of Contents](#table-of-contents)
  - [Installation](#installation)
    ...
    - [Build Docker Image and Run](#build-docker-image-and-run)
    - [Installation video](#installation-video)
  - [Uninstallation](#uninstallation)
    - [On Debian/Ubuntu Based Systems](#on-debianubuntu-based-systems)
